      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12 space-y-4">
          <div className="flex justify-center mb-4">
            <div className="p-3 bg-[#d4af37]/10 rounded-full text-[#d4af37] animate-pulse">
              <Sparkles size={32} />
            </div>
          </div>
          <h2 className="text-[#d4af37] text-sm uppercase tracking-widest">Módulo de IA Consciente</h2>
        ...
        <div className="glass-card rounded-xl p-6 md:p-10 border-[#1e3a8a]/30">
          <form onSubmit={handleAsk} className="space-y-6">
            <div className="relative">
              ...
              <textarea
                ...
                className="w-full bg-black/50 border border-zinc-800 rounded-lg p-4 pl-12 text-zinc-300 focus:outline-none focus:border-[#d4af37] transition-colors resize-none h-32"
              />
            </div>
            <Button 
              type="submit" 
          ...
          {response && (
            <div className="mt-10 p-6 bg-[#1e3a8a]/10 border-l-4 border-[#d4af37] rounded-r-lg animate-in fade-in slide-in-from-bottom-4 duration-700">
              <h5 className="text-[#d4af37] text-xs font-bold uppercase mb-4 tracking-tighter flex items-center">
                <span className="w-2 h-2 bg-[#d4af37] rounded-full mr-2 animate-ping"></span>
